...
final class TableViewDataSourceSubscriptTests: XCTestCase {
    ...
    func test_ThatTableViewDataSourceProvider_ReturnsExpectedDataFrom_IntSubscript() {
        ...
        let section = dataSourceProvider.dataSource[2]
    ...
    func test_ThatTableViewDataSourceProvider_SetsExpectedDataAt_IntSubscript() {
        ...
        XCTAssertTrue(dataSourceProvider.dataSource[index].headerTitle == expectedSection.headerTitle, "Section set at subscript should equal expected section")
        XCTAssertTrue(dataSourceProvider.dataSource[index].footerTitle == expectedSection.footerTitle, "Section set at subscript should equal expected section")
    ...
    func test_ThatTableViewDataSourceProvider_ReturnsExpectedDataFrom_IndexPathSubscript() {
        ...
        let item = dataSourceProvider.dataSource[indexPath]
